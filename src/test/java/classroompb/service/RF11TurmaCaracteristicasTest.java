...
class RF11TurmaCaracteristicasTest {
    ...
    void deveRN06NaoPermitirProfessorDoiHorarios() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
                turmaService.ofertarTurma("CC101", "P001", periodo, 25, "08:00-10:00", "Sala A2"));
    }
    ...
    void deveRN06PermitirProfessorHorariosForados() {
        ...
        Turma turma2 = turmaService.ofertarTurma("CC101", "P001", periodo, 25, "14:00-16:00", "Sala A2");
    ...
    void deveRN06PermitirProfessorHorariosBackToBack() {
        ...
        Turma turma2 = turmaService.ofertarTurma("CC102", "P001", periodo, 25, "10:00-12:00", "Sala A2");
    ...
    void deveRN02DetectarConflitosDeHorario() {
        ...
        Turma turma1 = turmaService.ofertarTurma("CC101", "P001", periodo, 30, "08:00-10:00", "Sala A1");
        
        // Cria outra disciplina
        disciplinaService.cadastrar("CC102", "Programação II", 60, 4);
        Turma turma2 = turmaService.ofertarTurma("CC102", "P002", periodo, 30, "09:00-11:00", "Sala A2");
    ...
    void deveRN02PermitirHorariosNaoConflitantes() {
        ...
        disciplinaService.cadastrar("CC102", "Programação II", 60, 4);
        Turma turma2 = turmaService.ofertarTurma("CC102", "P002", periodo, 30, "10:00-12:00", "Sala A2");
    ...
    void deveRN12ReprovacaoPorFaltaPrevalesce() {
        ...
        String situacao2 = turmaService.calcularSituacaoAluno(9.0, 50); // Excelente nota, mas faltas altas
        assertEquals("REPROVADO_POR_FALTA", situacao2);
        
        String situacao3 = turmaService.calcularSituacaoAluno(10, 0); // Perfeito em nota, não compareceu
    ...
    void deveTrabalharComMultiplasTurmasSameDisiplina() {
        ...
        Turma turma1 = turmaService.ofertarTurma("CC101", "P001", periodo, 30, "08:00-10:00", "Sala A1");
        Turma turma2 = turmaService.ofertarTurma("CC101", "P002", periodo, 25, "10:00-12:00", "Sala B1");
